...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/kyralretsam-cloudbees-ci-workshop/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>kyralretsam-cloudbees-ci-workshop</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>kyralretsam-cloudbees-ci-workshop</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/kyralretsam-cloudbees-ci-workshop/pipeline-template-catalog.git</repositoryUrl>
              <traits>
